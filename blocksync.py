...
if __name__ == "__main__":
    ...
    parser.add_option("--no-compress", dest = "compress", action = "store_false", help = "disable compression over SSH (defaults to on)")
    ...
    parser.add_option("-I", "--interpreter", dest = "interpreter", help = "[full path to] interpreter used to invoke remote server (defaults to python)", default = "python")
